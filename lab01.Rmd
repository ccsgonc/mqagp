...
O pacote [microdatasus](https://github.com/rfsaldanha/microdatasus) no R é uma ferramenta que permite acessar e trabalhar com microdados de diferentes dados_sims de dados disponibilizadas pelo Departamento de Informática do Sistema Único de Saúde (DATASUS) no Brasil. 
...
# leitur dos pacotes utilizados
library(readxl)

# leitura da base
projecoes_DF_IBGE <- read_excel("G:/.shortcut-targets-by-id/1q5zhH7F2EGGYSFqpV9B6vv6IAfBkEcDz/TR_Projecoes_2030/Banco de dados/Estatística/Projecoes_IBGE/indicadores_projecoes_DF_IBGE.xlsx")

# salvar base
saveRDS(projecoes_DF_IBGE,"projecoes_DF_IBGE.rds")
