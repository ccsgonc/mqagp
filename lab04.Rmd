...
Lendo os dados das projeções populacionais especialmente da Unidade da Federação escolhida. O arquivo auxiliar está disponível [aqui](https://github.com/ccsgonc/mqagp/blob/main/indicadores_projecoes_DF_IBGE.xlsx).
...
library(readxl)
pop_m_15_49 <- read_excel("G:/.shortcut-targets-by-id/1q5zhH7F2EGGYSFqpV9B6vv6IAfBkEcDz/TR_Projecoes_2030/Banco de dados/Estatística/Projecoes_IBGE/pop_m_15-49.xlsx")
...
tabela2[,c("ano","faixa_idade_mae_15_49","nasc_ajust")]
...
ano4<-2010:2030
var1<-c(tabela3$tft,rep(NA,10))
var2<-c(tabela3$tft_m,rep(NA,10))
